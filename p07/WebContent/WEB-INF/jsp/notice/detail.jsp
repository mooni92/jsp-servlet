  ...
  <tr>
   <td colspan="2"><c:out value="${board.content}" /></td>
	...
	<div class="col-6 mx-auto">
  	...
  	<input type= "button" value= "목록" onclick= "location.href='${pageContext.request.contextPath}/notice/list'"> 
  		</div>
  	</div>
...
{
    if(value==0) 
        location.href= cp + "/notice/update?bno=${board.bno}";//수정
    else if(value==1)//삭제
        location.href= cp + "/notice/delete?bno=${board.bno}";
}
