...
<table>
   ...
   <tr>
      ...
      <td><a href="${pageContext.request.contextPath}/notice/detail?bno=${b.bno}"> <c:out value="${b.title}" /></a><span class = "text-muted small">[${b.replyCnt}]</span></td>
   	...
   	<td colspan="4">
   		<ul class="pagination justify-content-end">
  			<li class="page-item ${page.prev ? '' : 'disabled'}">
  				<a class="page-link" href="${pageContext.request.contextPath}/notice/list?pageNum=${page.startPage-1}&amount=${page.cri.amount}">Previous</a>
  			</li>
  			
  			<c:forEach begin="${page.startPage}" end="${page.endPage}" var="p">
  			<li class="page-item ${p == page.cri.pageNum ? 'active' : ''}">
  			<a class="page-link" href="${pageContext.request.contextPath}/notice/list?pageNum=${p}&amount=${page.cri.amount}">${p}</a>
  			</li>
  			</c:forEach>
  			<li class="page-item ${page.next ? '' : 'disabled'}">
  			<a class="page-link" href="${pageContext.request.contextPath}/notice/list?pageNum=${page.endPage+1}&amount=${page.cri.amount}">Next</a></li>
	</ul>
   		<%-- ${page} --%>
   	</td>
   	</tr>
